...
The next meeting will be on <time datetime="2025-11-20T15:00:00Z">November 20, 2025 at 3:00 PM UTC</time>.

You can also show just the date:

- Project deadline: <time datetime="2025-12-01">December 1, 2025</time>
...
| Code block                     | <pre>`language\ncode\n`</pre>      | `js\nconsole.log("hi")\n`     |
| Blockquote                     | `> quote`                          | > quote                       |
| Horizontal rule                | `---` or `***`                     | ———                           |
| Highlight (HTML)               | `<mark>highlight</mark>`           | <mark>highlight</mark>        |
| Subscript / Superscript (HTML) | `<sub>sub</sub>`, `<sup>sup</sup>` | H<sub>2</sub>O, x<sup>2</sup> |
